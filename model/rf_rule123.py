...
def read_json(filename):
    ...
    with open(filename, 'r', encoding='utf8') as fp:
        ...
        # else:
        #     feature = [0]
        feature = [1 if prod_typ == "CREATE" else 0, 1 if prod_typ == "DELETE" else 0,
                   add_call_line,add_condition_line,add_parameter_line,add_return_line,del_call_line,del_condition_line,del_parameter_line,del_return_line
                   ,add_field_line,del_field_line]
        features.append(feature)
        # if test_typ != "Non":
        #     if (test_typ == "CREATE" or test_typ == "DELETE") and test_typ == prod_typ:
        #         target.append(1)
        #     else:
        #         target.append(0)
        # else:
